...
(function (c, g, k, f, b) {
    ...
    a.ITEM.COMMAND = a.ITEM.Subclass({
        action: function () {}, Init: function (r, t, s) {
...
MathJax.Hub.Register.LoadHook("[MathJax]/jax/element/mml/jax.js", function () {
    ...
    a.math.Augment({
        toMathML: function (c, d) {
            ...
            var k = (this.data[0] && this.data[0].data.length > 1);
            var n = this.type,
            ...
            if (f) {
                ...
                h.push(c + '    <annotation encoding="' + f + '">' + d.originalText + "</annotation>");
                h.push(c + "  </semantics>")
            }
            return c + "<" + n + j + ">\n" + h.join("\n") + "\n" + c + "</" + n + ">"
        }
