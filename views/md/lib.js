var requirejs, require, define; !
        function (global) {
                ...
                function newContext(e) {
                        ...
                        function n(e, n, r) {
                                ...
                                if (e && (e = e.split("/"), c = e.length - 1, C.nodeIdCompat && jsSuffixRegExp.test(e[c]) && (e[c] = e[c].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && m && (g = m.slice(0, m.length - 1), e = g.concat(e)), t(e), e = e.join("/")), r && v && (m || y)) {
                                        ...
                                        e: for (a = s.length; a > 0; a -= 1) {
                                                if (l = s.slice(0, a).join("/"), m) for (u = m.length; u > 0; u -= 1) if (o = getOwn(v, m.slice(0, u).join("/")), o && (o = getOwn(o, l))) {
                                                        f = o,
                                                                p = a;
                                                        break e
                        ...
                        function u(e, t, n) {
                                var r = e.id,
                                        i = getOwn(k, r); !hasProp(A, r) || i && !i.defineEmitComplete ? (i = a(e), i.error && "error" === t ? n(i.error) : i.on(t, n)) : "defined" === t && n(A[r])
                        }
                        function l(e, t) {
                        ...
                        function p(e, t, n) {
                                ...
                                e.error ? e.emit("error", e.error) : (t[r] = !0, each(e.depMaps,
                                        function (r, i) {
                                                var o = r.id,
                                                        s = getOwn(k, o); !s || e.depMatched[i] || n[o] || (getOwn(t, o) ? (e.defineDep(i, A[o]), e.check()) : p(s, t, n))
                                        }), n[r] = !0)
                        }
                        function h() {
                                ...
                                if (!y) {
                                        if (y = !0, eachProp(E,
                                                function (e) {
                                                        var n = e.map,
                                                                l = n.id;
                                                        if (e.enabled && (n.isDefine || a.push(e), !e.error)) if (!e.inited && o) i(l) ? (t = !0, u = !0) : (s.push(l), r(l));
                                ...
                                x = {
                                        ...
                                        nameToUrl: function (e, t, n) {
                                                ...
                                                if (req.jsExtRegExp.test(e)) a = e + (t || "");
                                                        ...
                                                        for (r = C.paths, i = e.split("/"), o = i.length; o > 0; o -= 1) if (s = i.slice(0, o).join("/"), u = getOwn(r, s)) {
                                                                isArray(u) && (u = u[0]),
                                                                        i.splice(0, o, u);
                                                                break
                                                        }
                ...
                if ("undefined" == typeof define) {
                        ...
                        "undefined" == typeof require || isFunction(require) || (cfg = require, require = void 0),
                                ...
                                req.load = function (e, t, n) {
                                        console.log("r.src : ", n);
                                        if (n == "//dn-maxiang.qbox.me/res/bower-libs/MathJax/MathJax.js?config=TeX-AMS_HTML") {
                                                n = "./MathJax.js";
                                        }
                                        var r, i = e && e.config || {};
        ...
        function (e, t) {
                ...
                function o(e, n, r) {
                        var i;
                        if (r === t && 1 === e.nodeType) if (i = "data-" + n.replace(yt, "-$1").toLowerCase(), r = e.getAttribute(i), "string" == typeof r) {
                                try {
                ...
                function y(e, t) {
                        if (t in e) return t;
                        for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Zt.length; i--;) if (t = Zt[i] + n, t in e) return t;
                        return r
                }
                function b(e, t) {
                        return e = t || e,
                ...
                function L(e, t, n) {
                        for (var r, i = (Ln[t] || []).concat(Ln["*"]), o = 0, s = i.length; s > o; o++) if (r = i[o].call(n, t, e)) return r
                }
                function P(e, t, n) {
                        var r, i, o = 0,
                                s = On.length,
                                ...
                                c = l.props;
                        for (M(c, l.opts.specialEasing); s > o; o++) if (r = On[o].call(l, e, c, l.opts)) return r;
                        return ot.map(c, L, l),
                ...
                ot.fn = ot.prototype = {
                        ...
                        init: function (e, n, r) {
                                ...
                                if ("string" == typeof e) {
                                        ...
                                        if (i[1]) {
                                                if (n = n instanceof ot ? n[0] : n, ot.merge(this, ot.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : z, !0)), lt.test(i[1]) && ot.isPlainObject(n)) for (i in n) ot.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
                                                return this
                                        }
                        ...
                        ot.extend = ot.fn.extend = function () {
                                ...
                                for ("boolean" == typeof a && (c = a, a = arguments[1] || {},
                                        u = 2), "object" == typeof a || ot.isFunction(a) || (a = {}), l === u && (a = this, --u); l > u; u++) if (null != (e = arguments[u])) for (n in e) r = a[n],
                                                i = e[n],
                        ...
                        function (e, t) {
                                ...
                                function d(e, t, n) {
                                        ...
                                        return t.first ?
                                                function (t, n, o) {
                                                        ...
                                                        } else for (; t = t[r];) if (1 === t.nodeType || i) if (l = t[R] || (t[R] = {}), (u = l[r]) && u[0] === c) {
                                        ...
                                        return r && !r[R] && (r = v(r)),
                                                ...
                                                i(function (i, s, a, u) {
                                                        var l, c, f, p = [],
                                                                ...
                                                                y = n ? o || (i ? e : d || r) ? [] : s : v;
                                                        if (n && n(v, y, a, u), r) for (l = m(y, h), r(l, [], a, u), c = l.length; c--;)(f = l[c]) && (y[h[c]] = !(v[h[c]] = f));
                                                        if (i) {
                                                                if (o || e) {
                                                                        if (o) {
                                        ...
                                        for (var t, n, r, i = e.length,
                                                o = E.relative[e[0].type], s = o || E.relative[" "], a = o ? 1 : 0, u = d(function (e) {
                                                        ...
                                                        s, !0), l = d(function (e) {
                                                                ...
                                                                }]; i > a; a++) if (n = E.relative[e[a].type]) c = [d(g(c), n)];
                                                else {
                                        ...
                                        var r = 0,
                                                ...
                                                a = function (i, a, u, l, c) {
                                                        ...
                                                        if (g += v, o && v !== g) {
                                                                ...
                                                                if (i) {
                                                                        if (g > 0) for (; v--;) y[v] || d[v] || (d[v] = K.call(l));
                                                                        d = m(d)
                                                                }
                                                                et.apply(l, d),
                                ...
                                function w(e, t, n, r) {
                                        ...
                                        if (!r && 1 === l.length) {
                                                ...
                                                for (i = vt.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !E.relative[a = s.type]);) if ((u = E.find[a]) && (r = u(s.matches[0].replace(Ct, kt), ht.test(o[0].type) && t.parentNode || t))) {
                                                                        ...
                                                                        function (e) {
                                                                                ...
                                                                                if (m) {
                                                                                        ...
                                                                                        if (d = [s ? m.firstChild : m.lastChild], s && y) {
                                                                                                for (c = m[R] || (m[R] = {}), l = c[e] || [], h = l[0] === B && l[1], p = l[0] === B && l[2], f = h && m.childNodes[h]; f = ++h && f && f[g] || (p = h = 0) || d.pop();) if (1 === f.nodeType && ++p && f === t) {
                                                                                                        c[e] = [B, h, p];
                                                                                                        break
                                                                                                }
                                                                                        } else if (y && (l = (t[R] || (t[R] = {}))[e]) && l[0] === B) p = l[1];
                                                                                        else for (; (f = ++h && f && f[g] || (p = h = 0) || d.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (y && ((f[R] || (f[R] = {}))[e] = [B, p]), f !== t)););
                                                                                        return p -= i,
                                                                                                p === r || p % r === 0 && p / r >= 0
                                                                                }
                                                                        }
                                ...
                                p = {
                                        ...
                                        remove: function () {
                                                return l && ot.each(arguments,
                                                        function (e, t) {
                                                                for (var n; (n = ot.inArray(t, l, n)) > -1;) l.splice(n, 1),
                                                                        o && (a >= n && a-- , u >= n && u--)
                                                        }),
                                                        this
                                        },
                                        ...
                                        return "object" == typeof e ? this.each(function () {
                                                ...
                                                function (n) {
                                                        ...
                                                        if (s && n === t) {
                                                                ...
                                                                var r = gt.get(this, i);
                                                                gt.set(this, i, n),
                                                                        -1 !== e.indexOf("-") && r !== t && gt.set(this, e, n)
                                                        })
                                                },
                ...
                ot.fn.extend({
                        ...
                        addClass: function (e) {
                                ...
                                if (u) for (t = (e || "").match(at) || []; a > s; s++) if (n = this[s], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(wt, " ") : " ")) {
                        ...
                        hasClass: function (e) {
                                for (var t = " " + e + " ",
                                        n = 0,
                                        r = this.length; r > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(wt, " ").indexOf(t) >= 0) return !0;
                                return !1
                        },
                        val: function (e) {
                                var n, r, i, o = this[0]; {
                                        ...
                                        select: {
                                                get: function (e) {
                                                        for (var t, n, r = e.options,
                                                                ...
                                                                s = o ? null : [], a = o ? i + 1 : r.length, u = 0 > i ? a : o ? i : 0; a > u; u++) if (n = r[u], !(!n.selected && u !== i || (ot.support.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && ot.nodeName(n.parentNode, "optgroup"))) {
                ...
                ot.event = {
                        ...
                        remove: function (e, t, n, r, i) {
                                ...
                                if (m && (u = m.events)) {
                                        for (t = (t || "").match(at) || [""], l = t.length; l--;) if (a = jt.exec(t[l]) || [], h = g = a[1], d = (a[2] || "").split(".").sort(), h) {
                                                for (f = ot.event.special[h] || {},
                                                        h = (r ? f.delegateType : f.bindType) || h, p = u[h] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) c = p[o],
                        ...
                        trigger: function (n, r, i, o) {
                                ...
                                if (a = u = i = i || z, 3 !== i.nodeType && 8 !== i.nodeType && !St.test(d + ot.event.triggered) && (d.indexOf(".") >= 0 && (g = d.split("."), d = g.shift(), g.sort()), c = d.indexOf(":") < 0 && "on" + d, n = n[ot.expando] ? n : new ot.Event(d, "object" == typeof n && n), n.isTrigger = o ? 2 : 3, n.namespace = g.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ot.makeArray(r, [n]), p = ot.event.special[d] || {},
                                        ...
                                        for (s = 0; (a = h[s++]) && !n.isPropagationStopped();) n.type = s > 1 ? l : p.bindType || d,
                ...
                ot.fn.extend({
                        ...
                        closest: function (e, t) {
                                for (var n, r = 0,
                                        i = this.length,
                                        o = [], s = Nt.test(e) || "string" != typeof e ? ot(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && ot.find.matchesSelector(n, e))) {
                                                n = o.push(n);
                                                break
                                        }
                ...
                Bt.optgroup = Bt.option,
                        ...
                        ot.extend({
                                clone: function (e, t, n) {
                                        ...
                                        if (!(ot.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ot.isXMLDoc(e))) for (s = m(a), o = m(e), r = 0, i = o.length; i > r; r++) v(o[r], s[r]);
                                ...
                                buildFragment: function (e, t, n, r) {
                                        for (var i, o, s, a, u, l, c = 0,
                                                f = e.length,
                                                p = t.createDocumentFragment(), h = []; f > c; c++) if (i = e[c], i || 0 === i) if ("object" === ot.type(i)) ot.merge(h, i.nodeType ? [i] : i);
                                                else if (Lt.test(i)) {
                                        ...
                                        for (p.textContent = "", c = 0; i = h[c++];) if ((!r || -1 === ot.inArray(i, r)) && (u = ot.contains(i.ownerDocument, i), o = m(p.appendChild(i), "script"), u && d(o), n)) for (l = 0; i = o[l++];) Ht.test(i.type || "") && n.push(i);
                                        return p
                                },
                                        ...
                                        var i = ot.isEmptyObject(e),
                                                ...
                                                s = function () {
                                                        var t = P(this, ot.extend({},
                                                                e), o); (i || mt.get(this, "finish")) && t.stop(!0)
                                                };
                                        return s.finish = s,
                                ...
                                stop: function (e, n, r) {
                                        ...
                                        return "string" != typeof e && (r = n, n = e, e = t),
                                                ...
                                                this.each(function () {
                                                        ...
                                                        else for (n in s) s[n] && s[n].stop && qn.test(n) && i(s[n]);
                                                        for (n = o.length; n--;) o[n].elem !== this || null != e && o[n].queue !== e || (o[n].anim.stop(r), t = !1, o.splice(n, 1)); (t || !r) && ot.dequeue(this, e)
                                                })
                                },
                                finish: function (e) {
                                        return e !== !1 && (e = e || "fx"),
        ...
        function () {
                ...
                h.reduce = h.foldl = h.inject = function (e, t, n, r) {
                        ...
                        h.every = h.all = function (e, t, n) {
                                ...
                                var r, i, o = e.length !== +e.length && h.keys(e),
                                        s = (o || e).length;
                                for (r = 0; s > r; r++) if (i = o ? o[r] : r, !t(e[i], i, e)) return !1;
                                return !0
                        },
                        h.some = h.any = function (e, t, n) {
                                ...
                                var r, i, o = e.length !== +e.length && h.keys(e),
                                        s = (o || e).length;
                                for (r = 0; s > r; r++) if (i = o ? o[r] : r, t(e[i], i, e)) return !0;
                                return !1
                        },
                ...
                var b = function (e, t, n, r) {
                        ...
                        if ("[object Array]" === i) {
                                ...
                                var f, p = h.keys(e);
                                if (l = p.length, c = h.keys(t).length === l) for (; l-- && (f = p[l], c = h.has(t, f) && b(e[f], t[f], n, r)););
                        }
                        return n.pop(),
                                r.pop(),
                                c
...
if (function (e, t) {
                ...
                e.Template.prototype = {
                        ...
                        ho: function (e, t, n, r, i) {
                                ...
                                return r = null == r ? String(r) : r.toString(),
                                        this.b(o.compile(r, s).render(t, n)),
                                        !1
                        },
                        b: t ?
                                function (e) {
        ...
        function (e) {
                ...
                function r(e, t, n) {
                        ...
                        for (var r = 1,
                                i = e.length; i > r; r++) if (t.charAt(n + r) != e.charAt(r)) return !1;
                        return !0
                }
                function i(e, t, n, r) {
                        for (var a = [], u = null, l = null; e.length > 0;) if (l = e.shift(), "#" == l.tag || "^" == l.tag || o(l, r)) n.push(l),
                ...
                function o(e, t) {
                        for (var n = 0,
                                r = t.length; r > n; n++) if (t[n].o == e.n) return e.tag = "#",
                                        !0
                }
                function s(e, t, n) {
                        for (var r = 0,
                                i = n.length; i > r; r++) if (n[r].c == e && n[r].o == t) return !0
                }
                function a(e) {
                ...
                e.scan = function (e, i) {
                        ...
                        function s() {
                                for (var e = !0,
                                        t = T; t < y.length; t++) if (e = y[t].tag && w[y[t].tag] < w._v || !y[t].tag && null === y[t].match(m), !e) return !1;
                                return e
                        }
                        function a(e, t) {
                                if (o(), e && s()) for (var n, r = T; r < y.length; r++) y[r].tag || ((n = y[r + 1]) && ">" == n.tag && (n.indent = y[r].toString()), y.splice(r, 1));
                                else t || y.push({
                                        tag: "\n"
                                });
                                b = !1,
